...
// ✅ Bank/Stripe — pa uuid, sesioni mban të dhënat
Route::get ('/payment',              [ShopController::class,   'bankSandbox'])->name('payment.page');
Route::post('/bank/confirm',         [ShopController::class,   'bankConfirm'])->name('bank.confirm');

// PaymentController (Stripe Intent)
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::post('/save-token', [AdminProfileController::class, 'saveToken'])->middleware('auth');
});
